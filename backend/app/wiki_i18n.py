...
UI_I18N = {
    "en": {
        ...
        "footer": "Generated from live code — <code>Config</code> defaults + <code>GodLaws</code> + <code>app.routes</code>. Official living documentation & encyclopedia for Flatland. · Developed by <strong>Long Phan</strong> — <a href=\"mailto:long@minhnhan.in\">long@minhnhan.in</a> · Demo: <a href=\"{frontend_url}\" target=\"_blank\" rel=\"noopener noreferrer\">Demo ↗</a> · Landing: <a href=\"{landing_url}\" target=\"_blank\" rel=\"noopener noreferrer\">Landing ↗</a> · GitHub: <a href=\"https://github.com/longphanmn/flws\" target=\"_blank\" rel=\"noopener noreferrer\">flws</a> / <a href=\"https://github.com/longphanmn/flws-web\" target=\"_blank\" rel=\"noopener noreferrer\">flws-web</a> · Built with OpenCode & Antigravity",
        ...
        "laws_title": "# Laws of the Sphere\n\nEvery law in `GodLaws` (`protocol.py:216`) with type/range/default. Set via `POST /api/laws` or presets.",
    ...
    "vi": {
        ...
        "footer": "Trích xuất trực tiếp từ mã nguồn — <code>Config</code> + <code>GodLaws</code> + <code>app.routes</code>. Bách khoa toàn thư sống chính thức của Flatland. · Phát triển bởi <strong>Long Phan</strong> — <a href=\"mailto:long@minhnhan.in\">long@minhnhan.in</a> · Bản demo: <a href=\"{frontend_url}\" target=\"_blank\" rel=\"noopener noreferrer\">Bản demo ↗</a> · Trang chủ: <a href=\"{landing_url}\" target=\"_blank\" rel=\"noopener noreferrer\">Trang chủ ↗</a> · GitHub: <a href=\"https://github.com/longphanmn/flws\" target=\"_blank\" rel=\"noopener noreferrer\">flws</a> / <a href=\"https://github.com/longphanmn/flws-web\" target=\"_blank\" rel=\"noopener noreferrer\">flws-web</a> · Xây dựng với OpenCode & Antigravity",
        ...
        "laws_title": "# Thiên luật của Khối Cầu (The Sphere)\n\nToàn bộ định luật trong `GodLaws` (`protocol.py:216`) kèm kiểu dữ liệu, phạm vi và giá trị mặc định. Thay đổi qua `POST /api/laws` hoặc chọn thiết lập mẫu.",
    ...
    "fr": {
        ...
        "footer": "Généré à partir du code source en temps réel — Valeurs <code>Config</code> + <code>GodLaws</code> + <code>app.routes</code>. Documentation vivante officielle et encyclopédie de Flatland. · Développé par <strong>Long Phan</strong> — <a href=\"mailto:long@minhnhan.in\">long@minhnhan.in</a> · Démo : <a href=\"{frontend_url}\" target=\"_blank\" rel=\"noopener noreferrer\">Démo ↗</a> · Accueil : <a href=\"{landing_url}\" target=\"_blank\" rel=\"noopener noreferrer\">Accueil ↗</a> · GitHub: <a href=\"https://github.com/longphanmn/flws\" target=\"_blank\" rel=\"noopener noreferrer\">flws</a> / <a href=\"https://github.com/longphanmn/flws-web\" target=\"_blank\" rel=\"noopener noreferrer\">flws-web</a> · Conçu avec OpenCode & Antigravity",
        ...
        "laws_title": "# Lois de la Sphère (The Sphere)\n\nTous les champs de `GodLaws` (`protocol.py:216`) — type, plage et valeur par défaut. Modifiables via `POST /api/laws` ou par préréglage.",
...
LAW_HINTS_I18N = {
    "en": {
        ...
        "plant_growth_rate": "How fast sprouted plants mature into harvestable food (0.05).",
        ...
        "food_lifespan_ticks": "Ticks a mature plant lives before naturally withering into the living soil grid (9000).",
        ...
        "perceive_radius": "Base perception sight radius (20.0) — scaled by caste (Woman 0.8×, Priest 1.35×), night (0.6×), and fog (0.6×).",
        ...
        "adult_age": "Ticks required for an infant/juvenile to mature into a sexually fertile adult (600.0).",
        "birth_rate": "Base reproduction probability per eligible adult mating pair per tick (0.05).",
        ...
        "annealing_decay_generations": "Generations over which polar morphology annealing decays from Abbott templates to free evolution (250).",
        ...
        "season_length": "Duration in ticks of each season (Spring, Summer, Autumn, Winter) (14400).",
        ...
        "exposure_drain": "Health and energy drain per tick when outdoors during harsh weather (0.03).",
        "house_capacity": "Bed capacity inside a settlement hall (12); excess members sleep outdoors.",
        "house_decay_ticks": "Ticks before an abandoned, roofless house crumbles into ruins (2400).",
        ...
        "territory_radius": "Radius of clan territorial influence around settlement houses (14.0).",
        "trespass_decay": "Diplomatic relation points lost per tick when a rival clan enters marked territory (0.25).",
        ...
        "schism_threshold": "Dissatisfaction fraction (hunger, homelessness) triggering a factional clan schism (0.5).",
        "war_enabled": "Enables inter-clan warfare, tactical raids, and territorial conquest.",
        "attack_damage": "Base damage dealt by soldiers and warriors in inter-clan battles (30.0).",
        "predation_enabled": "Enables carnivorous predator-prey ecology and hunting dynamics.",
        "predator_ratio": "Fraction of population spawned as predatory carnivores hunting prey (0.0).",
        "hunt_radius": "Aggro detection radius within which carnivores and war parties acquire targets (8.0).",
        "bite_damage": "Combat damage dealt per carnivore attack or predatory strike (28.0).",
        "energy_from_prey": "Caloric energy extracted from slaying and eating a prey creature (40.0).",
        ...
        "cannibalism_energy": "Energy gained by starving creatures resorting to eating fallen kin or rivals (35.0).",
        ...
        "age_length": "Duration in ticks per world historical epoch (12000).",
        "culture_enabled": "Enables traditions, governance archetypes, and cultural diffusion.",
        "culture_spread_rate": "Rate at which allied clans sharing borders adopt common cultural traits and beliefs (0.005).",
        ...
        "disaster_rate": "Stochastic probability of catastrophic environmental disasters (0.00004).",
    ...
    "vi": {
        ...
        "plant_growth_rate": "Tốc độ cây non sinh trưởng thành cây có thể thu hoạch (0.05).",
        ...
        "food_lifespan_ticks": "Thời gian tồn tại của cây trưởng thành trước khi tự rũ bỏ thân xác vào đất (9000 nhịp).",
        ...
        "perceive_radius": "Bán kính quan sát chuẩn (20.0) — biến đổi theo giai tầng (Nữ giới 0.8×, Tế tư 1.35×), đêm tối (0.6×) và sương mù (0.6×).",
        ...
        "adult_age": "Số nhịp cần thiết để con non trưởng thành và có thể sinh sản (600.0).",
        "birth_rate": "Tỷ lệ thụ thai cơ bản của mỗi cặp đôi trưởng thành đủ no mỗi nhịp (0.05).",
        ...
        "annealing_decay_generations": "Số thế hệ để quá trình ủ nhiệt chuyển từ khuôn mẫu Abbott sang tiến hóa tự do (250).",
        ...
        "season_length": "Độ dài của một mùa (Xuân, Hạ, Thu, Đông) theo số nhịp (14400).",
        ...
        "exposure_drain": "Tổn hại máu và năng lượng mỗi nhịp khi phơi mình ngoài sương gió mùa đông (0.03).",
        "house_capacity": "Số lượng chỗ nằm trong mỗi căn nhà (12); thành viên vượt mức phải ngủ ngoài trời.",
        "house_decay_ticks": "Thời gian một căn nhà bỏ hoang sụp đổ thành phế tích (2400 nhịp).",
        ...
        "territory_radius": "Bán kính tầm ảnh hưởng lãnh thổ tỏa ra từ các căn nhà của thị tộc (14.0).",
        "trespass_decay": "Điểm bang giao bị khấu trừ mỗi nhịp khi kẻ thù tự tiện bước vào lãnh địa (0.25).",
        ...
        "schism_threshold": "Tỷ lệ bất mãn thổi bùng làn sóng ly khai chia rẽ nội bộ (0.5).",
        "war_enabled": "Chiến tranh liên thị tộc, tập kích cướp lương và mở rộng bờ cõi.",
        "attack_damage": "Sát thương cơ bản do binh sĩ gây ra trong chiến trận (30.0).",
        "predation_enabled": "Kích hoạt chuỗi thức ăn thú săn mồi ăn thịt và con mồi ăn cỏ.",
        "predator_ratio": "Tỷ lệ sinh ra thú ăn thịt hung hãn trong tự nhiên (0.0).",
        "hunt_radius": "Bán kính săn mồi và truy sát mục tiêu của thú ăn thịt (8.0).",
        "bite_damage": "Sát thương từ vết cắn xé của thú ăn thịt (28.0).",
        "energy_from_prey": "Năng lượng calo hấp thụ được khi săn gục và ăn thịt con mồi (40.0).",
        ...
        "cannibalism_energy": "Năng lượng thu được khi ăn thịt một cá thể đồng loại lúc đói lả (35.0).",
        ...
        "age_length": "Độ dài của một thời đại lịch sử tính theo số nhịp (12000).",
        "culture_enabled": "Bản sắc văn hóa, tập tục và sự lan tỏa tập quán giữa các thị tộc.",
        "culture_spread_rate": "Tốc độ truyền bá tập tục văn hóa sang các thị tộc đồng minh cận kề (0.005).",
        ...
        "disaster_rate": "Xác suất ngẫu nhiên giáng xuống đại thảm họa thiên nhiên (0.00004).",
    ...
    "fr": {
        ...
        "plant_growth_rate": "Vitesse de maturation des jeunes pousses en nourriture récoltable (0.05).",
        ...
        "food_lifespan_ticks": "Durée de vie en ticks d'une plante mûre avant son retour à la terre (9000).",
        ...
        "perceive_radius": "Rayon de vision de base (20.0) — modulé par caste (Femme 0.8×, Prêtre 1.35×), nuit (0.6×) et brume (0.6×).",
        ...
        "adult_age": "Ticks requis pour qu'un nouveau-né atteigne la maturité reproductrice (600.0).",
        "birth_rate": "Probabilité d'engendrement par couple adulte éligible et par tick (0.05).",
        ...
        "annealing_decay_generations": "Générations requises pour que le recuit passe des gabarits d'Abbott à l'évolution libre (250).",
        ...
        "season_length": "Durée en ticks de chaque saison (Printemps, Été, Automne, Hiver) (14400).",
        ...
        "exposure_drain": "Perte d'énergie et de vie lors des intempéries hors de tout abri (0.03).",
        "house_capacity": "Nombre de places de couchage dans une halle (12) ; l'excédent dort à la belle étoile.",
        "house_decay_ticks": "Ticks avant qu'une maison abandonnée et sans toit ne tombe en ruine (2400).",
        ...
        "territory_radius": "Rayon d'influence territoriale d'un clan autour de ses habitations (14.0).",
        "trespass_decay": "Dégradation diplomatique par tick lorsqu'un clan rival franchit la frontière (0.25).",
        ...
        "schism_threshold": "Taux d'insatisfaction (faim, sans-abri) déclenchant une scission de faction (0.5).",
        "war_enabled": "Active les conflits armés entre clans rivaux, raids tactiques et conquêtes.",
        "attack_damage": "Dégâts de base infligés par les soldats lors des affrontements de clans (30.0).",
        "predation_enabled": "Active la dynamique proie-prédateur et le régime carnivore.",
        "predator_ratio": "Proportion de la population naissant avec l'instinct carnivore de chasse (0.0).",
        "hunt_radius": "Rayon de détection d'agression dans lequel prédateurs et guerriers ciblent leurs proies (8.0).",
        "bite_damage": "Dégâts physiques causés par morsure ou attaque prédatrice (28.0).",
        "energy_from_prey": "Gain calorique extrait de la capture et dévoration d'une proie (40.0).",
        ...
        "cannibalism_energy": "Énergie retirée de la consommation d'un congénère ou d'un ennemi terrassé (35.0).",
        ...
        "age_length": "Durée en ticks de chaque époque historique du monde (12000).",
        "culture_enabled": "Active les traditions, archétypes de gouvernement et diffusion culturelle.",
        "culture_spread_rate": "Vitesse d'adoption des traits culturels et dogmes entre clans voisins (0.005).",
        ...
        "disaster_rate": "Probabilité aléatoire d'avènement de calamités environnementales (0.00004).",
